                ...
                <Box position={'relative'}>
                    <Container>
                        <Stack py={{ base: 4, md: 20, xl: 50 }}>
                            ...
                            <Link href={"https://www.carstyleai.com"} target={"_blank"}>
                                <Flex
                                    p={4}
                                    bg={useColorModeValue("white", "gray.800")}
                                    rounded="xl"
                                        ...
                                        <VStack align="start" justify="flex-start" spacing={1}>
                                            <VStack spacing={0} align="start">
                                                ...
                                                <Text
                                                    ...
                                                    color={useColorModeValue("neutral.1000", "neutralD.1000")}
                                                >
                                                    Design your car with artificial intelligence.
                                                </Text>
                                            </VStack>
                                        </VStack>
                                    </Box>
                            ...
                            <Link href={"https://socialsbooster.nl/"} target={"_blank"}>
                                <Flex
                                    p={4}
                                    bg={useColorModeValue("white", "gray.800")}
                                    rounded="xl"
                                        ...
                                        <VStack align="start" justify="flex-start" spacing={1}>
                                            <VStack spacing={0} align="start">
                                                ...
                                                <Text
                                                    ...
                                                    color={useColorModeValue("neutral.1000", "neutralD.1000")}
                                                >
                                                    Purchase a boost in followers, likes, and views on both Instagram and TikTok.
                                                </Text>
                                            </VStack>
                                        </VStack>
                                    </Box>
