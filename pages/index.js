                ...
                <Box position={'relative'}>
                    <Container>
                        <Stack py={{ base: 4, md: 20, xl: 50 }}>
                            ...
                            <Link href={"https://www.tailwindgrabber.com"} target={"_blank"}>
                                <Flex
                                    p={4}
                                    bg={useColorModeValue("white", "gray.800")}
                                    rounded="xl"
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        >
                                            <Image
                                                src={"/images/tailwindgrabber.png"}
                                        ...
                                        <VStack align="start" justify="flex-start" spacing={1}>
                                            <VStack spacing={0} align="start">
                                                ...
                                                <Text
                                                    ...
                                                    color={useColorModeValue("neutral.1000", "neutralD.1000")}
                                                >
                                                    A seamless extension for extracting Tailwind elements, effortlessly.
                                                </Text>
                                            </VStack>
                                        </VStack>
                                    </Box>
                            ...
                            <Link href={"https://www.footballplayerai.com"} target={"_blank"}>
                                <Flex
                                    p={4}
                                    bg={useColorModeValue("white", "gray.800")}
                                    rounded="xl"
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        >
                                            <Image
                                                src="/images/footballplayerai.png"
                                                layout="fixed"
                                                rounded="md"
                                            />
                                        </Box>
                                        ...
                                        <VStack align="start" justify="flex-start" spacing={1}>
                                            <VStack spacing={0} align="start">
                                                ...
                                                <Text
                                                    ...
                                                    color={useColorModeValue("neutral.1000", "neutralD.1000")}
                                                >
                                                    Virtually transform into your favorite football club uniform using AI.
                                                </Text>
                                            </VStack>
                                        </VStack>
                                    </Box>
